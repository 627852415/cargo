...
public class NumberUtils {
     ...
     * @return
     */
    public static BigDecimal keepScale4RoundDown(BigDecimal value, int scale) {
     ...
     * @return 两个参数的积
     */
    public static BigDecimal multiply4RoundDown(BigDecimal value1, BigDecimal value2, int scale) {
     ...
     * @return 两个参数的积
     */
    public static BigDecimal multiply4RoundUp(BigDecimal value1, BigDecimal value2, int scale) {
    	BigDecimal value = value1.multiply(value2);
